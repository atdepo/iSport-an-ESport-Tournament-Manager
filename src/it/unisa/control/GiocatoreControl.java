		...
		case "totalValidate":
			...
			try {
				...
				//Se i dati della squadra sono buoni
					...
					Part image= request.getPart("images");//Prende la parte dal multipart form che rappresenta l'immagine della squadra
					...
					if(image==null)
						...
						System.out.println("L'immagine è nulla++++++++++++++++++++++++++++++++++++");
						}
					else {
						//Immagine -> BASE64
					...
					sq.add(team);
					request.getSession().setAttribute("squadreTorneo", sq);
